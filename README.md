...
**Внимание:** Данный репозиторий не является сборником завершенных игр или
...
* Каталог lib16bit - прототип библиотеки для создания игр, с примерами для Си, Паскаля и Бейсика
...
Проект библиотеки, которая позволит быстро создавать игры для 16-битного
DOS с поддержкой VGA (экранный режим 0x13 - 320x200x256).
Завершенная версия будет включать в себя файлы для использования в Си-компиляторах,
в FreePascalCrossCompiler, а также для Бейсика
